...
import { isHTMLElement } from "../util/type-utils";
...
function useDraggableBlockMenu(
  ...
  return createPortal(
    <>
      <div
        className={
          "rounded px-px py-0.5 cursor-grab opacity-0 absolute left-0 top-0 will-change-transform active:cursor-grabbing hover:bg-gray-200" +
        ...
        onDragEnd={onDragEnd}
      >
        <div className={isEditable ? "icon" : ""}>db</div>
      </div>
      <div
        className=" pointer-events-none bg-blue-100 h-1 absolute left-0 top-0 opacity-0 will-change-transform"
        ref={targetLineRef}
      />
    </>,
    anchorElem
